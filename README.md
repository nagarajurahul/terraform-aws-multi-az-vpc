...
`Note:` NAT Gateways are created in the same AZ, hence, we need to create public subnet along with private subnet. This is to avoid cross-AZ data traffic costs for NATs in different AZ.
